...
/**
 * Main thread.
 * Choose input 'largeints' or 'smallints'.
 * Choose N (size of input to sort).
 * Choose whether to sort array before testing algorithms or not.
 * Choose whether to reverse array before testing algorithms or not.
 * Choose which algorithm to test (Quicksort or Mergesort).
 */
public class Main {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //MyInsertionTest.insertionSort(data, 0, N-1);
